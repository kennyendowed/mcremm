...
import aveter from "../../../assets/img/team/profile-picture-3.jpg";
    ...
    <div className="d-flex justify-content-between w-100" id="navbarSupportedContent">
      ...
      <ul className="navbar-nav align-items-center">
        <li className="nav-item dropdown ms-lg-3">
          <a className= { dropdown ? "nav-link dropdown-toggle pt-1 px-0" : "nav-link dropdown-toggle pt-1 px-0 show"}  onClick={() => dropdownNavState()}  aria-expanded= { dropdown ? "true" :"false" }>
            <div className="media d-flex align-items-center">
              <img className="avatar rounded-circle" alt="Image placeholder" src={aveter} />
              <div className="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                <span className="mb-0 font-small fw-bold text-gray-900">Bonnie Green</span>
              </div>
            </div>
          </a>
          <div className={ dropdown ?"dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1 show":"dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1"}>
